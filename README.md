# Api De M Tricas Simples Cb9Ad1

Aplicação backend `api-de-m-tricas-simples-cb9ad1` construída com foco em boas práticas de engenharia.

## Visão Geral
- Nome da aplicação: `api-de-m-tricas-simples-cb9ad1`
